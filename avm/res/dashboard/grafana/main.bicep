...
metadata description = 'This Module deploys a Grafana instance on Azure and applies a lock to the resource. The Grafana instance provides powerful visualization and analytics capabilities for your data.'
